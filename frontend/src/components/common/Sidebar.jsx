...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    {
      to: "/app/dashboard",
      label: terminology.dashboard || "Dashboard",
      icon: BarChart3,
      description: "Analytics & Overview",
    },
    {
      to: "/app/assets",
      label: terminology.assets || "Assets",
      icon: Laptop,
      description: "Equipment Management",
    },
    {
      to: "/app/maintenance",
      label: terminology.maintenance || "Maintenance",
      icon: Wrench,
      description: "Service & Repairs",
    },
    {
      to: "/app/reports",
      label: terminology.reports || "Reports",
      icon: FileText,
    ...
    <>
      ...
      <motion.aside
        ...
        style={{
          ...
          boxShadow:
            "inset -1px 0 0 0 rgba(255, 255, 255, 0.5), 8px 0 32px rgba(0, 0, 0, 0.04), 0 0 80px rgba(0, 0, 0, 0.02)",
        }}
      ...
      >
        ...
        >
          ...
          <h2 className="text-lg font-bold text-slate-800 tracking-tight">
            {branding.companyName || "Asset Management"}
          </h2>
                  ...
                  return (
                    <motion.li key={item.to} variants={itemVariants}>
                      <NavLink
                        ...
                        className={({ isActive }) => {
                          const baseClasses =
                            "group relative flex items-center gap-4 px-5 py-4 mb-1 text-[13px] font-semibold rounded-[14px] transition-all duration-400 ease-[cubic-bezier(0.23,1,0.32,1)] hover:shadow-lg hover:shadow-black/5 focus:outline-none focus:ring-2 focus:ring-blue-500/20 active:scale-[0.97] overflow-hidden";
                          ...
                          <>
                            ...
                            <motion.div
                              className={
                                ...
                                (isActive
                                  ? "bg-white/15"
                                  : "bg-slate-100/80 group-hover:bg-white/90")
                              }
                    ...
                    return (
                      <motion.li key={item.to} variants={itemVariants}>
                        <NavLink
                          ...
                          className={({ isActive }) => {
                            const baseClasses =
                              "group relative flex items-center gap-4 px-5 py-4 mb-1 text-[13px] font-semibold rounded-[14px] transition-all duration-400 ease-[cubic-bezier(0.23,1,0.32,1)] hover:shadow-lg hover:shadow-black/5 focus:outline-none focus:ring-2 focus:ring-red-500/20 active:scale-[0.97] overflow-hidden";
                            const activeClasses = isActive
                            ...
                            <>
                              ...
                              <motion.div
                                className={
                                  ...
                                  (isActive
                                    ? "bg-white/15"
                                    : "bg-red-50/80 group-hover:bg-red-100/90")
                                }
                                whileHover={{ scale: 1.05, rotate: 1 }}
                                whileTap={{ scale: 0.95 }}
                                transition={{ duration: 0.2 }}
