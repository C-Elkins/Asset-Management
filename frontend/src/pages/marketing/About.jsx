  ...
  return (
    <MarketingLayout>
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        {/* Mission */}
        <div className="relative overflow-hidden rounded-[32px] p-12 border border-blue-100 mb-16" style={{ background: 'linear-gradient(135deg, #eff6ff 0%, #ecfdf5 100%)' }}>
          {/* Gradient blob */}
          <div 
        ...
        {/* Timeline */}
        <div className="relative overflow-hidden rounded-[32px] p-12 border border-blue-100 mb-16" style={{ background: 'linear-gradient(135deg, #eff6ff 0%, #d1fae5 100%)' }}>
          {/* Gradient blob */}
          <div 
