...
import { CategoryManagement } from "./settings/CategoryManagement.jsx";
...
export function SettingsPageModern() {
  ...
  const darkModeAllowed =
    ...
    localStorage.getItem("feature_dark_mode") === "on";
    ...
    (async () => {
      try {
        ...
        if (err?.response?.status === 403) {
          ...
          if (mounted)
            setError("Failed to load settings. Using last known values.");
        }
      } finally {
  ...
  const sections = [
    ...
    },
    {
      ...
      title: "Categories",
      icon: Package,
      description: "Manage asset categories for your organization",
      color: "green",
      isCustom: true,
    },
    {
  ...
  const handleReset = () => {
    if (confirm("Reset all settings to default values?")) {
      ...
      addToast({
        type: "info",
        title: "Info",
        message: "Settings reset to defaults (not yet saved)",
      });
    }
  };
  ...
  const toggleSetting = (section, key) => {
    ...
    if (section === "system" && key === "showTooltips") {
      ...
      addToast({
        ...
        title:
          "Tooltips " +
          (globalSettings?.system?.showTooltips ? "Disabled" : "Enabled"),
                ...
                <div className="settings-card">
                  ...
                  <div className="settings-form">
                    {Object.entries(activeData).map(([key, value], index) => {
                      ...
                      const displayValue =
                        activeSection === "system" && key === "showTooltips"
                      ...
                      const descriptions = {
                        showTooltips:
                          "Show helpful hints and explanations throughout the app",
                      };
                        ...
                        >
                          <div className="settings-form-item-info">
                            <label className="settings-form-label">
                              ...
                              {key === "showTooltips" && (
                                <HelpCircle className="w-4 h-4 inline ml-2 text-gray-400" />
                              )}
                              {key === "darkMode" &&
                                (displayValue ? (
                                  <Moon className="w-4 h-4 inline ml-2 text-gray-400" />
                                ) : (
                                  <Sun className="w-4 h-4 inline ml-2 text-gray-400" />
                                ))}
                            </label>
